...
print("***** RUNNING MAIN.PY - NEW VERSION")
...
embedding = get_embedding("This meeting discussed project deadlines.")
...
for i in range(5):
    ...
    text = test.iloc[i]["transcript"][:1000]   # Only first 1000 characters
...
"""
    ...
    print(f"Transcript {i+1} Sentiment: {response.text.splitlines()[0]}")